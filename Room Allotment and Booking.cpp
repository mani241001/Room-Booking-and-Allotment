...
void RoomAllotment::installation()
{
  cout<<"Enter Room no: ";
  cin>>room[p].roomn;
  cout<<"\nEnter Host's name: ";
...
void RoomAllotment::position(int l)
{
  int s=0;p=0;
  for (int i =0; i<8;i++)
  {
